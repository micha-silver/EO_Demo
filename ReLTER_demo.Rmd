...
This code demonstrates the use of the new `ReLTER` package.
...
The code below demonstrates how to access various data from ODS,
...
To restore normal NDVI values, divide raster by 
